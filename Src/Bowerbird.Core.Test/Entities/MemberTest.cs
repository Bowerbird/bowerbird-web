...
namespace Bowerbird.Core.Test.Entities
{
    ...
    public class MemberTest
    {
        ...
        [Test]
        [Category(TestCategory.Unit)]
        public void Member_Roles_Is_TypeOf_DenormalisedNamedEntityReference_Role_List()
        {
            var testMember = new ProxyObjects.ProxyMember(FakeObjects.TestUser(), FakeObjects.TestRoles());

            Assert.IsInstanceOf<List<DenormalisedNamedEntityReference<Role>>>(testMember.Roles);
        }
