...
namespace Bowerbird.Core.Test.Entities
{
    ...
    public class RoleTest
    {
        ...
        [Test]
        [Category(TestCategory.Unit)]
        public void Role_Permissions_Is_ListOf_DenormalisedNamedEntityReference_Permission()
        {
            Assert.IsInstanceOf<List<DenormalisedNamedEntityReference<Permission>>>(TestRole().Permissions);
        }
