...
namespace Bowerbird.Core.Test.CommandHandlers
{
    ...
    public class ObservationCommentUpdateCommandHandlerTest
    {
        ...
        private ObservationCommentUpdateCommand TestObservationCommentUpdateCommand()
        {
        ...
        public void ObservationCommentUpdateCommandHandler_Constructor_Passing_Null_Something_Throws_DesignByContractException()
        {
           // Assert.IsTrue(BowerbirdThrows.Exception<DesignByContractException>(() => new ObservationCommentUpdateCommandHandler(null)));
        }
