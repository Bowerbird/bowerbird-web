...
namespace Bowerbird.Core.CommandHandlers
{
    ...
    public class IdentificationCreateCommandHandler : ICommandHandler<IdentificationCreateCommand>
    {
        #region Members
        ...
        public IdentificationCreateCommandHandler(
        ...
        public void Handle(IdentificationCreateCommand command)
        {
