...
namespace Bowerbird.Core.CommandHandlers
{
    ...
    public class MediaResourceUpdateCommandHandler : ICommandHandler<MediaResourceUpdateCommand>
    {
        #region Fields
        ...
        public MediaResourceUpdateCommandHandler(
        ...
        public void Handle(MediaResourceUpdateCommand command)
        {
