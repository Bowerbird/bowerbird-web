...
{
    public class MediaResourceDynamic : DynamicObject
    {
        #region Members
        ...
        protected MediaResourceDynamic()
        {
        }

        public MediaResourceDynamic(
            string mediaType,
            User createdByUser,
            DateTime uploadedOn,
            string key)
            : base()
        {
            ...
            _properties.Add("User", (DenormalisedUserReference)createdByUser);
        ...
        public MediaResourceDynamic AddMetadata(string key, string value)
        {
        ...
        {
            if (((IDictionary<string, object>)_properties[mediaType]).ContainsKey(storedRepresentation))
            {
                ((IDictionary<string, object>)_properties[mediaType]).Remove(storedRepresentation);
            }

            ((IDictionary<string, object>)_properties[mediaType]).Add(storedRepresentation, file);
        }
