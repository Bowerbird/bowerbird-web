...
namespace Bowerbird.Web.Builders
{
    public class ActivityViewModelBuilder : IActivityViewModelBuilder
    {
        ...
        public object BuildHomeActivityList(string userId, ActivityInput activityInput, PagingInput pagingInput)
        {
            ...
            //var contributionIds = activities.SelectMany(x => new [] { x.ContributionId, x.SubContributionId });

            //var contributions = _documentSession
            //    .Query<All_Contributions.Result, All_Contributions>()
            //    .Where(x => x.ContributionId.In(contributionIds))
            //    .ToList();
            ...
            //                {
            //                    var result = contributions.FirstOrDefault(y => y.ContributionId == x.ContributionId && (y.ContributionType == "observation" || y.ContributionType == "record"));
            ...
            //                {
            //                    var result = contributions.FirstOrDefault(y => y.ContributionId == x.ContributionId && y.SubContributionId == x.SubContributionId && y.ContributionType == "identification");
            //                    object sighting = null;
            ...
            //                {
            //                    var result = contributions.FirstOrDefault(y => y.ContributionId == x.ContributionId && y.SubContributionId == x.SubContributionId && y.ContributionType == "note");
            //                    object sighting = null;
