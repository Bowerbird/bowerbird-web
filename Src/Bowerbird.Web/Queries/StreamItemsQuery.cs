...
namespace Bowerbird.Web.Queries
{
    public class StreamItemsQuery : IStreamItemsQuery
    {
        ...
        public PagedList<StreamItem> GetStreamItems(StreamItemListInput listInput, StreamSortInput sortInput)
        {
        ...
        private PagedList<StreamItem> GetHomeStreamItems(StreamItemListInput listInput, StreamSortInput sortInput)
        {
        ...
        private PagedList<StreamItem> GetGroupStreamItems(StreamItemListInput listInput, StreamSortInput sortInput)
        {
            RavenQueryStatistics stats;
