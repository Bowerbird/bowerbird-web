...
function ($, _, Backbone, app, ich, ProjectItemView) {
    ...
    var ProjectExploreView = Backbone.Marionette.CompositeView.extend({
        ...
        serializeData: function () {
            return {
                Model: {
                    ...
                    ShowProjectExploreWelcome: _.contains(app.authenticatedUser.callsToAction, 'project-explore-welcome')
                }
            };
        },
        ...
        showLoading: function () {
            ...
            this.$el.find('.project-items').fadeOut(100, function () {
                that.onLoadingStart();
            });
        }
    });
