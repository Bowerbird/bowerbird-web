...
*/
		...
		_init: function() {
			...
			this.internal.flash = $.extend({}, {
				...
				jq: undefined,
				swf: '/js/libs/jquery.jplayer/jplayer.swf'//this.options.swfPath + (this.options.swfPath.toLowerCase().slice(-4) !== ".swf" ? (this.options.swfPath && this.options.swfPath.slice(-1) !== "/" ? "/" : "") + "jplayer.swf" : "")
			});
